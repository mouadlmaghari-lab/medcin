...
{
    /**
     * List appointments (Assistant can manage appointments).
     * GET /api/v1/assistant/appointments?date=&date_from=&date_to=&etat=&patient_id=
     */
    ...
    public function store(StoreAppointmentRequest $request): JsonResponse
    {
        ...
        $data['booking_source'] = $data['booking_source'] ?? 'assistant';
