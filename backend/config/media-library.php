...
return [
     ...
     * Set to 10 MB to match patient analyses upload limit from PRD.
     */
     ...
     */
    // TabibCare custom path generator: /{tenant_id}/{patient_id}/{collection}/{filename}
    'path_generator' => App\Services\Media\TabibCarePathGenerator::class,
